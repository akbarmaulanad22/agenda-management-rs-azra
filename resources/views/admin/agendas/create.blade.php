    ...
    <div class="max-w-3xl">
        <div class="bg-white rounded-3xl border border-gray-100 overflow-hidden">
            <div class="px-8 py-6 border-b border-gray-100">
                ...
                <p class="text-sm text-gray-400 mt-0.5">Lengkapi informasi agenda rapat dan detail surat undangan</p>
            </div>
            <div class="p-8">
                <form action="{{ route('admin.agendas.store') }}" method="POST" class="space-y-5">
                    ...
                    <div class="pb-4 border-b border-gray-100">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" name="title" id="title" value="{{ old('title') }}" placeholder="Contoh: Undangan Sosialisasi Form E-MR Asuhan Keperawatan" class="block w-full px-4 py-3 rounded-2xl border border-gray-200 bg-gray-50/50 text-sm text-gray-900 placeholder-gray-400 transition duration-200 focus:bg-white focus:border-primary focus:ring-2 focus:ring-primary/20 focus:outline-none" required>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div>
                                    ...
                                    <input type="text" name="location" id="location" value="{{ old('location') }}" placeholder="Contoh: Training Center" class="block w-full px-4 py-3 rounded-2xl border border-gray-200 bg-gray-50/50 text-sm text-gray-900 placeholder-gray-400 transition duration-200 focus:bg-white focus:border-primary focus:ring-2 focus:ring-primary/20 focus:outline-none" required>
                        ...
                        <div class="space-y-4">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="letter_number" id="letter_number" value="{{ old('letter_number') }}" placeholder="Contoh: 001/SIRS-RSAZRA/XI/2024" class="block w-full px-4 py-3 rounded-2xl border border-gray-200 bg-gray-50/50 text-sm text-gray-900 placeholder-gray-400 transition duration-200 focus:bg-white focus:border-primary focus:ring-2 focus:ring-primary/20 focus:outline-none">
                            ...
                            <div>
                                ...
                                <textarea name="letter_recipient" id="letter_recipient" rows="4" placeholder="Contoh:&#10;Wakil Direktur&#10;Manager Medis&#10;Manager Keperawatan&#10;Kepala Rekam Medis&#10;Seluruh Kepala Ruangan Keperawatan" class="block w-full px-4 py-3 rounded-2xl border border-gray-200 bg-gray-50/50 text-sm text-gray-900 placeholder-gray-400 transition duration-200 focus:bg-white focus:border-primary focus:ring-2 focus:ring-primary/20 focus:outline-none">{{ old('letter_recipient') }}</textarea>
                            ...
                            <div>
                                ...
                                <textarea name="letter_body" id="letter_body" rows="4" placeholder="Contoh: Sehubungan dengan persiapan penerapan rekam medis elektronik, maka perlunya dilakukan sosialisasi form-form asuhan keperawatan baik rawat jalan, rawat inap, OK, dan VK" class="block w-full px-4 py-3 rounded-2xl border border-gray-200 bg-gray-50/50 text-sm text-gray-900 placeholder-gray-400 transition duration-200 focus:bg-white focus:border-primary focus:ring-2 focus:ring-primary/20 focus:outline-none">{{ old('letter_body') }}</textarea>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <select name="created_by_signer_id" id="created_by_signer_id" class="block w-full px-4 py-3 rounded-2xl border border-gray-200 bg-gray-50/50 text-sm text-gray-900 transition duration-200 focus:bg-white focus:border-primary focus:ring-2 focus:ring-primary/20 focus:outline-none" required>
                                    ...
                                    @foreach($signers as $signer)
                                        <option value="{{ $signer->id }}" {{ old('created_by_signer_id') == $signer->id ? 'selected' : '' }}>{{ $signer->name }} - {{ $signer->position }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <select name="validated_by_signer_id" id="validated_by_signer_id" class="block w-full px-4 py-3 rounded-2xl border border-gray-200 bg-gray-50/50 text-sm text-gray-900 transition duration-200 focus:bg-white focus:border-primary focus:ring-2 focus:ring-primary/20 focus:outline-none" required>
                                    <option value="">-- Pilih Penandatangan --</option>
                                    @foreach($signers as $signer)
                                        <option value="{{ $signer->id }}" {{ old('validated_by_signer_id') == $signer->id ? 'selected' : '' }}>{{ $signer->name }} - {{ $signer->position }}</option>
                                    @endforeach
                                </select>
                    ...
                    {{-- Section: Peserta --}}
                    <div x-data="participantSelector({{ json_encode($participants->map(fn($p) => ['id' => $p->id, 'name' => $p->name, 'department' => $p->department])) }}, {{ json_encode(old('participants', [])) }})">
                        <h4 class="text-sm font-bold text-gray-800 mb-4 flex items-center gap-2">
