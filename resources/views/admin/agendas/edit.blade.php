<x-app-layout>
    ...
    <div class="max-w-3xl">
        <div class="bg-white rounded-3xl border border-gray-100 overflow-hidden">
            ...
            <div
                class="p-8"
                x-data="{ type: '{{ old('type', $agenda->type) }}' }"
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <x-searchable-select
                                    ...
                                    :selected-id="old('organizer_id', $agenda->organizer_id)"
                                    :selected-label="old('organizer_id') ? null : $agenda->organizer?->full_name"
                            ...
                            <div>
                                ...
                                <x-searchable-select
                                    ...
                                    search-url="{{ route('admin.employees.search') }}"
                                    :selected-id="old('meeting_chair_id', $agenda->meeting_chair_id)"
                                    :selected-label="old('meeting_chair_id') ? null : $agenda->meetingChair?->full_name"
                                    placeholder="Cari pegawai..."
                                    required
                                />
                            ...
                            <div>
                                ...
                                <x-searchable-select
                                    ...
                                    :selected-id="old('type', $agenda->type)"
                                    :selected-label="old('type') ? null : ucfirst($agenda->type)"
