<x-app-layout>
    ...
    @php
        $oldQuestions = old('questions', $bankSoal->questions->map(fn($q) => [
    ...
    <div class="max-w-4xl" x-data="{ questions: {{ json_encode($oldQuestions) }} }">
            ...
            <div class="bg-white rounded-3xl border border-gray-100 overflow-hidden">
                <div class="px-8 py-6 border-b border-gray-100 flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-sm text-gray-400 mt-0.5">Ubah soal pilihan ganda (A-E)</p>
                    </div>
