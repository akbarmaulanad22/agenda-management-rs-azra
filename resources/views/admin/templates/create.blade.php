<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-2 text-sm">
            ...
            <span class="font-semibold text-gray-700">Tambah Template</span>
        </div>
    </x-slot>
    ...
    <div class="max-w-3xl">
        <div class="bg-white rounded-3xl border border-gray-100 overflow-hidden">
            <div class="px-8 py-6 border-b border-gray-100">
                ...
                <p class="text-sm text-gray-400 mt-0.5">Buat template surat undangan rapat</p>
            </div>
            <div class="p-8">
                <form action="{{ route('admin.templates.store') }}" method="POST" class="space-y-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name') }}" placeholder="Contoh: Undangan Rapat Koordinasi" class="block w-full px-4 py-3 rounded-2xl border border-gray-200 bg-gray-50/50 text-sm text-gray-900 placeholder-gray-400 transition duration-200 focus:bg-white focus:border-primary focus:ring-2 focus:ring-primary/20 focus:outline-none" required>
                    ...
                    <div>
                        ...
                        <textarea name="body_content" id="body_content" rows="12" placeholder="Tulis isi template surat undangan di sini..." class="block w-full px-4 py-3 rounded-2xl border border-gray-200 bg-gray-50/50 text-sm text-gray-900 font-mono placeholder-gray-400 transition duration-200 focus:bg-white focus:border-primary focus:ring-2 focus:ring-primary/20 focus:outline-none" required>{{ old('body_content') }}</textarea>
