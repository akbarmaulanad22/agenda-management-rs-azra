<nav x-data="{ open: false }" class="bg-gradient-to-r from-primary to-primary-700 border-b border-primary-800">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-4 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('admin.participants.index')"
                        :active="request()->routeIs('admin.participants.*')"
                        class="text-white hover:text-secondary-200 border-secondary">
                        Peserta
                    </x-nav-link>
                    <x-nav-link :href="route('admin.signers.index')" :active="request()->routeIs('admin.signers.*')"
                        class="text-white hover:text-secondary-200 border-secondary">
                        Penandatangan
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('admin.agendas.index')" :active="request()->routeIs('admin.agendas.*')"
                        class="text-white hover:text-secondary-200 border-secondary">
                        Agenda
                    </x-nav-link>
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('admin.participants.index')"
                :active="request()->routeIs('admin.participants.*')">Peserta</x-responsive-nav-link>
            <x-responsive-nav-link :href="route('admin.signers.index')"
                :active="request()->routeIs('admin.signers.*')">Penandatangan</x-responsive-nav-link>
            <x-responsive-nav-link :href="route('admin.templates.index')"
                :active="request()->routeIs('admin.templates.*')">Template</x-responsive-nav-link>
            <x-responsive-nav-link :href="route('admin.agendas.index')"
                :active="request()->routeIs('admin.agendas.*')">Agenda</x-responsive-nav-link>
        </div>
